...
* dudael\_archive\_hero.png (1920×600px)  
...
* dudael\_favicon.ico (32×32px, 16×16px)  
  * Simplified sigil or hourglass icon  
* dudael\_logo\_light.svg (256×256px)  
  * Full logo with "Dudael" wordmark for light backgrounds  
* dudael\_logo\_dark.svg (256×256px)  
  * Same logo optimized for dark theme  
* dudael\_icon\_square.png (512×512px)  
...
| ----- | ----- | ----- |
| World & Lore | icon\_lore.svg | Open book with spiral binding or angelic wing silhouette |
| Entities & Classes | icon\_bound.svg | Five overlapping circles (the Five Bound) or vessel sigil |
| Game Loop & Systems | icon\_systems.svg | Circular arrow loop (7 phases) or hourglass |
| Brand & Aesthetic | icon\_brand.svg | Sinerine tri-polar palette symbol (Light/Dark/Threshold gradient) |
| Engine & Architecture | icon\_engine.svg | Gear or layered stack diagram (Meta/Bound/Mode) |
| Content & Production | icon\_pipeline.svg | Conveyor belt or checklist clipboard |
...
| ----- | ----- | ----- |
| Seraph | sigil\_seraph.svg | Radiant six-winged figure, Light-aligned gold tones |
| Shadow | sigil\_shadow.svg | Cloaked silhouette, Dark-aligned violet/indigo |
| Exile | sigil\_exile.svg | Broken chain or fractured halo, Threshold gray/amber blend |
| Penitent | sigil\_penitent.svg | Kneeling figure or hands clasped, muted Light tones |
| Rebel | sigil\_rebel.svg | Raised fist or inverted wing, Sharp Dark accents |
...
* phase\_flow\_diagram.png (1600×900px)  
...
Bonus: Interactive SVG version (phase\_flow\_interactive.svg) with clickable phase nodes linking to relevant docs
...
* architecture\_three\_layer.png (1200×800px)  
...
* architecture\_phasewall\_runrepo.png (1200×800px)  
...
* architecture\_redux\_tree.png (1000×1200px)  
  * Root: dudaelState  
...
* brand\_tokens\_showcase.png (1600×1200px)  
  * Grid layout showing:  
...
Alternate format: Interactive web component (brand\_tokens.html) pulling live from Supabase vfapalette, vfatypography tables
...
| ----- | ----- | ----- |
| Architecture | banner\_architecture.png | Layered stack diagram with gear motif |
| Lore Bible | banner\_lore.png | Spiral galaxy or angelic wing with scripture reference (Jude 1:6) |
| Bound Spec | banner\_bound.png | Five Bound sigils in a row |
| Systems Spec | banner\_systems.png | Hourglass or circular loop with Light/Dark balance scales |
| Brand Guide | banner\_brand.png | Sinerine tri-polar gradient |
| Content Pipeline | banner\_pipeline.png | Conveyor belt with idea→implementation flow |
| Refactor Log | banner\_refactor.png | Git commit graph or timeline with checkmarks |
...
* og\_archive\_home.png (1200×630px)  
  * "Dudael System Library Archive" \+ hero visual  
* og\_lore.png (1200×630px)  
  * "Dudael Lore Bible" \+ key angel silhouette  
* og\_architecture.png (1200×630px)  
...
* badge\_complete.svg (80×24px) — Green checkmark, "Complete"  
* badge\_in\_progress.svg (80×24px) — Yellow dot, "In Progress"  
* badge\_backlog.svg (80×24px) — Gray dash, "Backlog"

### **Phase Icons (mini set for inline use)**

* phase\_icon\_title.svg through phase\_icon\_drop.svg (7 icons, 32×32px)  
  * Simplified icons for each phase (e.g., crown for Title, card for Draft, door for Door, hourglass for Drop)

### **Alignment Indicators**

* alignment\_light.svg (48×48px) — Glowing amber circle  
* alignment\_dark.svg (48×48px) — Deep violet circle  
* alignment\_secret.svg (48×48px) — Gradient Light→Dark blend
...
* site\_layout\_mockup.png (1920×1080px)  
...
1. Hero banner (dudael\_archive\_hero.png)  
2. Favicon set (dudael\_favicon.ico, dudael\_logo\_light.svg, dudael\_logo\_dark.svg)  
3. Domain category icons (6 icons: lore, bound, systems, brand, engine, pipeline)  
4. Phase flow diagram (phase\_flow\_diagram.png)  
5. Documentation navigation banners (7 banners)

### **Tier 2: High-Value (Generate Second)**

6. Five Bound sigils (sigil\_seraph.svg through sigil\_rebel.svg)  
7. Architecture diagrams (3: three-layer, PhaseWall/RunRepo, Redux tree)  
8. Brand token showcase (brand\_tokens\_showcase.png)
...
\[1\] dudael\_archive\_hero.png \- Full-width header with forensic theophany aesthetic, spiral patterns, Light/Dark gradient, and archive title

### **2\. Logo/Favicon**

\[2\] dudael\_logo\_icon.png \- Hourglass with sacred geometry, works as favicon or standalone logo mark

### **3\. Domain Category Icons**

\[3\] domain\_icons\_set.png \- All six navigation icons (Lore, Bound, Systems, Brand, Engine, Pipeline) in a single sheet

### **4\. Phase Flow Diagram**

\[4\] phase\_flow\_diagram.png \- Complete seven-phase loop with PhaseWall boundaries, Run Repo data store, and Light/Dark color coding

### **5\. Documentation Navigation Banners**

banner\_architecture.png \- Layered stack with gear motif  
banner\_lore.png \- Spiral galaxy with angelic wing and Jude 1:6 reference  
banner\_bound.png \- Five Bound sigils in a row  
banner\_systems.png \- Hourglass with balance scales (Light/Dark)  
banner\_brand.png \- Sinerine tri-polar palette bars banner\_pipeline.png \- Conveyor belt workflow stages banner\_refactor.png \- Git commit graph with checkmarks
...
(see the generated image above) sigil\_seraph.png \- Radiant six-winged figure, amber-gold Light alignment  
(see the generated image above) sigil\_shadow.png \- Cloaked mysterious form, violet-indigo Dark alignment  
(see the generated image above) sigil\_exile.png \- Broken chain/fractured halo, Threshold gray with mixed glows  
(see the generated image above) sigil\_penitent.png \- Kneeling figure in prayer, muted amber seeking restoration  
(see the generated image above) sigil\_rebel.png \- Raised fist/inverted wing, intense violet defiance

### **Architecture Diagrams (Technical Documentation)**

(see the generated image above) arch\_three\_layer.png \- Meta Guides / The Bound / Descent Mode layer visualization  
(see the generated image above) arch\_phasewall\_runrepo.png \- PhaseWall ephemeral packets vs Run Repo persistent state comparison  
(see the generated image above) arch\_redux\_tree.png \- Complete Redux state tree showing game/meta/UI branches

### Brand System Documentation

## brand\_tokens\_showcase.png \- Sinerine design system: 43 tokens covering color palette (Light/Dark/Threshold scales), typography (Cinzel/Inter/JetBrains Mono), and spacing/shadows
...
\[1\] location\_threshold.png \- Liminal boundary zone with grayscale tones and soft amber/violet edges, transitional atmosphere  
\[2\] location\_crossroads.png \- Three diverging door paths glowing Light (amber), Dark (violet), and Secret (gray blend)  
\[3\] location\_sanctum.png \- Clinical sacred space flooded with intense amber-gold Light, forensic examination aesthetic  
\[4\] location\_abyss.png \- Deep containment prison with massive chains, oppressive violet-black depths, eternal weight

### **Three Social Sharing Open Graph Images (1200×630px each)**

\[5\] og\_home.png \- Archive homepage card with hourglass symbol and complete documentation tagline  
\[6\] og\_lore.png \- Lore Bible card with six-winged angel silhouette and theology focus  
\[7\] og\_architecture.png \- Architecture card with technical diagram snippet and Redux/PhaseWall callouts

### **Supplementary UI Elements**

\[8\] status\_badges.png \- Three badges (Complete/In Progress/Backlog) for task tracking in documentation  
(see the generated image above) phase\_icons\_mini.png \- Seven 32×32px phase icons (crown, cursor, table, card, room, doors, hourglass) for inline use  
(see the generated image above) alignment\_indicators.png \- Three 48×48px circular icons (Light amber, Secret gradient, Dark violet) for UI displays

### **Site Layout Blueprint**

(see the generated image above) site\_layout\_mockup.png (1920×1080px) \- Complete webpage wireframe showing header, sidebar navigation, main content area with banners and diagrams, and footer
...
│   │   ├── banner\_systems.png  
│   │   ├── banner\_brand.png  
│   │   ├── banner\_pipeline.png  
│   │   └── banner\_refactor.png  
│   ├── characters/  
│   │   ├── sigil\_seraph.png  
│   │   ├── sigil\_shadow.png  
│   │   ├── sigil\_exile.png  
...
│   ├── diagrams/  
│   │   ├── phase\_flow.png  
│   │   ├── arch\_three\_layer.png  
│   │   ├── arch\_phasewall\_runrepo.png  
│   │   ├── arch\_redux\_tree.png  
│   │   └── brand\_tokens\_showcase.png  
│   ├── locations/  
│   │   ├── location\_threshold.png  
│   │   ├── location\_crossroads.png  
│   │   ├── location\_sanctum.png  
│   │   └── location\_abyss.png  
│   ├── social/  
│   │   ├── og\_home.png  
│   │   ├── og\_lore.png  
│   │   └── og\_architecture.png  
│   ├── ui/  
│   │   ├── status\_badges.png  
│   │   ├── phase\_icons\_mini.png  
│   │   └── alignment\_indicators.png  
│   └── mockups/  
│       └── site\_layout\_mockup.png
...
1. Dudael\_Architecture.md  
2. Dudael\_Lore\_Bible.md  
3. Dudael\_Bound\_Spec.md  
4. Dudael\_Systems\_Spec.md  
5. Sinerine\_Brand\_Guide.md  
6. Dudael\_Content\_Pipeline.md  
7. Dudael\_Refactor\_Log.md

Each would use its corresponding banner as header imagery.

### **Option C: Create the Workspace Index**

Build the Dudael\_Workspace\_Index.md file that ties everything together with links to all docs and asset directories.
...
Which direction would you like to pursue? I can help you build out any of these next steps.
...
* Build Dudael\_Workspace\_Index.md  
...
2. Dudael\_Workspace\_Index.md (Master navigation hub)  
...
3. FOLDER\_STRUCTURE.md (Organization guide)  
...
5. ASSET\_INVENTORY.md (Visual asset catalog)  
...
dudael-system-library/  
├── README.md (✓ Created)  
├── Dudael\_Workspace\_Index.md (✓ Created)  
├── FOLDER\_STRUCTURE.md (✓ Created)  
├── IMPLEMENTATION.md (✓ Created)  
├── ASSET\_INVENTORY.md (✓ Created)  
...
Today (2-3 hours): 4\. Move your existing files to /archive per the checklist 5\. Place all 31 assets in their designated folders 6\. Verify folder structure matches the guide

This Week (8-12 hours): 7\. Begin drafting the 7 core documentation files (start with Refactor\_Log.md) 8\. Extract content from archived sources 9\. Write database seed scripts
...
\#\#\# 1\. \*\*seed\_brand\_identity.sql\*\* (Brand & Design System)  
\*\*Tables created:\*\*  
...
\- Card parity effects (light\_delta, dark\_delta)  
...
\*\*Order matters:\*\* \`seed\_bound\_configs.sql\` must run before \`seed\_litegame\_content.sql\` because skills table references bounds table.
...
SELECT \* FROM unlocked\_bounds;  \-- Should show Seraph and Shadow

\-- Check game content  
SELECT COUNT(\*) FROM cards;  \-- Should return 13  
SELECT COUNT(\*) FROM levels;  \-- Should return 5  
SELECT \* FROM card\_catalog;  \-- Should show cards with tags  
\`\`\`
...
1\. \*\*Sinerine\_Brand\_Guide.md\*\* — References color tokens and typography specs  
2\. \*\*Dudael\_Bound\_Spec.md\*\* — Uses Vessel stats and Guide data  
3\. \*\*Dudael\_Systems\_Spec.md\*\* — References card parity, level data  
4\. \*\*Dudael\_Content\_Pipeline.md\*\* — Templates match these table structures
...
\*\*Potential additions:\*\*  
\- \`game\_runs\` table (track player runs)  
\- \`player\_profiles\` table (meta-progression)  
\- \`achievements\` table (unlock tracking)  
\- \`lore\_fragments\` table (discoverable narrative)  
